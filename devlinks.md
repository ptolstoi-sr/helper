...
[Asynchrone Programmierung](https://learn.microsoft.com/de-de/dotnet/csharp/asynchronous-programming/async-scenarios)  
...
[My experience of using the Clean Architecture with a Modular Monolith](https://www.thereformedprogrammer.net/my-experience-of-using-the-clean-code-architecture-with-a-modular-monolith/)  
...
[Freigeben von Controllern, Ansichten, Razor Seiten und mehr mit Anwendungsparts](https://learn.microsoft.com/de-de/aspnet/core/mvc/advanced/app-parts)  
## Monolit Core
...
[.NET-Microservices: .NET-Microservices-Architektur für .NET-Containeranwendungen](https://learn.microsoft.com/de-de/dotnet/architecture/microservices/)  
[Hosten von ASP.NET Core in Docker-Containern](https://learn.microsoft.com/de-de/aspnet/core/host-and-deploy/docker/?view=aspnetcore-7.0)  
...
[LDAP Access Control for ASP.Net](https://www.c-sharpcorner.com/article/ldap-access-control-for-Asp-Net/)  
### JWT
...
[Best Free Admin Dashboard Templates](https://htmltemplates.co/free-dashboard-templates)  
[AdminKit is a free & open-source HTML dashboard & admin template based on Bootstrap 5.](https://github.com/adminkit/adminkit)  
[Atrana Dashboard](https://github.com/atranathemes/Atrana)  
[Tailwind Admin](https://github.com/habibmhamadi/tailwind-admin)  
